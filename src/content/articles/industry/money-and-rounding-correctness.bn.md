> **পাঠ 29 · শুরুর ধাপ** - 0.1 + 0.2 মানে 0.3 নয়, তিন line item-এ ভাগ করা ১৫% VAT invoice total-এ ফেরে না, আর পার্থক্যটা কাউকে ব্যাখ্যা করতে হয় reconciliation report-এ।
...
- এই পাঠটা ঠিক **অর্থ, rounding ও float-এর ফাঁদ** নিয়ে। ট্যাগ: money, rounding, decimals, floats, currency।
...
flowchart TD
  ...
  D --> E["অর্থ, rounding ও float-এর ফাঁদ"]
  E --> F["সীমা + ডিগ্রেড"]
```

ভাঙে প্রযুক্তির নামে নয়, চুক্তির অভাবে। Vue/Quasar স্ক্রিন আর Laravel রাইট যদি উল্টো উত্তর ধরে, প্রোডাকশন সেই রেসটা খুঁজে বের করে। এই টপিকের চুক্তিটা হলো: 0.1 + 0.2 মানে 0.3 নয়, তিন line item-এ ভাগ করা ১৫% VAT invoice total-এ ফেরে না, আর পার্থক্যটা কাউকে ব্যাখ্যা করতে হয় reconciliation report-এ।
...
0.1 + 0.2 মানে 0.3 নয়, তিন line item-এ ভাগ করা ১৫% VAT invoice total-এ ফেরে না, আর পার্থক্যটা কাউকে ব্যাখ্যা করতে হয় reconciliation report-এ। এই বাক্য পিআর, Pinia অ্যাকশন, আর Laravel ক্লাসে রাখুন।
...
রিট্রাই অ্যামপ্লিফিকেশন, টাকা মিলের ফারাক, আর ডিপেন্ডেন্সি এরর বাজেট। **অর্থ, rounding ও float-এর ফাঁদ**-এর রিগ্রেশন এই চার্টে না ধরা পড়লে পাঠ শেষ হয়নি।
...
- [ ] **অর্থ, rounding ও float-এর ফাঁদ**-এর ইনভেরিয়েন্ট এক বাক্যে লেখা।
- [ ] খালি, ডুপ্লিকেট, টাইমআউট বা পারমিশন পাথের টেস্ট বা রিহার্সাল আছে।
- [ ] এক ডিপ্লয়ের মধ্যে রিগ্রেশন ধরার লগ বা চার্ট আছে।
- [ ] আত্মীয় পাঠ এখনও মিলছে: unicode-and-encoding-edge-cases, duplicate-submission-prevention, leap-day-and-calendar-edge-cases।
