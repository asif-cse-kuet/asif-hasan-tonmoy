> **পাঠ 61 · মাঝারি ধাপ** - micro-batch window, single-flight dedup, আর ৫ ms অপেক্ষা লাভজনক কি না তার হিসাব।
...
- এই পাঠটা ঠিক **Tail latency না বাড়িয়ে batching ও request coalescing** নিয়ে। ট্যাগ: batching, coalescing, single-flight, throughput, dataloader।
...
flowchart TD
  ...
  C --> D["টাইমআউট"]
  D --> E["Tail latency না বাড়িয়ে batching ও request coalescing"]
  E --> F["বাজেট + হিস্টোগ্রাম"]
```

ভাঙে প্রযুক্তির নামে নয়, চুক্তির অভাবে। Vue/Quasar স্ক্রিন আর Laravel রাইট যদি উল্টো উত্তর ধরে, প্রোডাকশন সেই রেসটা খুঁজে বের করে। এই টপিকের চুক্তিটা হলো: micro-batch window, single-flight dedup, আর ৫ ms অপেক্ষা লাভজনক কি না তার হিসাব।
...
micro-batch window, single-flight dedup, আর ৫ ms অপেক্ষা লাভজনক কি না তার হিসাব। এই বাক্য পিআর, Pinia অ্যাকশন, আর Laravel ক্লাসে রাখুন।
...
লেটেন্সির হিস্টোগ্রাম (শুধু গড় নয়), রেসপন্স বাইট, আর রিকোয়েস্টপ্রতি CPU। **Tail latency না বাড়িয়ে batching ও request coalescing**-এর রিগ্রেশন এই চার্টে না ধরা পড়লে পাঠ শেষ হয়নি।
...
- [ ] **Tail latency না বাড়িয়ে batching ও request coalescing**-এর ইনভেরিয়েন্ট এক বাক্যে লেখা।
- [ ] খালি, ডুপ্লিকেট, টাইমআউট বা পারমিশন পাথের টেস্ট বা রিহার্সাল আছে।
- [ ] এক ডিপ্লয়ের মধ্যে রিগ্রেশন ধরার লগ বা চার্ট আছে।
- [ ] আত্মীয় পাঠ এখনও মিলছে: payload-size-and-serialization-cost, littles-law-capacity-planning, hot-path-query-optimization।
