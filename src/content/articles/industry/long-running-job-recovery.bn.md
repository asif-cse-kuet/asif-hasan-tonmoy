> **পাঠ 147 · উন্নত ধাপ** - ছয় ঘণ্টার import পাঁচ ঘণ্টায় rolling deploy-এ মারা গেলে checkpoint থেকে resume করবে নাহলে শুরু থেকে - আর শুরু থেকে করলেই ৪০,০০০ row double-charge।
...
- এই পাঠটা ঠিক **দীর্ঘ job-এর recovery** নিয়ে। ট্যাগ: jobs, checkpointing, resumability, workers, batch।
...
flowchart TD
  ...
  D --> E["দীর্ঘ job-এর recovery"]
  E --> F["সীমা + ডিগ্রেড"]
```

ভাঙে প্রযুক্তির নামে নয়, চুক্তির অভাবে। Vue/Quasar স্ক্রিন আর Laravel রাইট যদি উল্টো উত্তর ধরে, প্রোডাকশন সেই রেসটা খুঁজে বের করে। এই টপিকের চুক্তিটা হলো: ছয় ঘণ্টার import পাঁচ ঘণ্টায় rolling deploy-এ মারা গেলে checkpoint থেকে resume করবে নাহলে শুরু থেকে - আর শুরু থেকে করলেই ৪০,০০০ row double-charge।
...
ছয় ঘণ্টার import পাঁচ ঘণ্টায় rolling deploy-এ মারা গেলে checkpoint থেকে resume করবে নাহলে শুরু থেকে - আর শুরু থেকে করলেই ৪০,০০০ row double-charge। এই বাক্য পিআর, Pinia অ্যাকশন, আর Laravel ক্লাসে রাখুন।
...
রিট্রাই অ্যামপ্লিফিকেশন, টাকা মিলের ফারাক, আর ডিপেন্ডেন্সি এরর বাজেট। **দীর্ঘ job-এর recovery**-এর রিগ্রেশন এই চার্টে না ধরা পড়লে পাঠ শেষ হয়নি।
...
- [ ] **দীর্ঘ job-এর recovery**-এর ইনভেরিয়েন্ট এক বাক্যে লেখা।
- [ ] খালি, ডুপ্লিকেট, টাইমআউট বা পারমিশন পাথের টেস্ট বা রিহার্সাল আছে।
- [ ] এক ডিপ্লয়ের মধ্যে রিগ্রেশন ধরার লগ বা চার্ট আছে।
- [ ] আত্মীয় পাঠ এখনও মিলছে: duplicate-submission-prevention, dependency-startup-ordering, partial-failure-handling।
