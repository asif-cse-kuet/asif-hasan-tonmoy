> **পাঠ 99 · মাঝারি ধাপ** - Cluster ফিরে আসে, ৪০,০০০ client একই ২০০ms-এ reconnect করে, আর cold cache নিয়ে আবার fail করেন। Recovery-র নিজের capacity plan আর নিজের jitter দরকার।
...
- এই পাঠটা ঠিক **Recovery-তে thundering herd** নিয়ে। ট্যাগ: thundering-herd, recovery, jitter, load-shedding, cold-cache।
...
flowchart TD
  ...
  D --> E["Recovery-তে thundering herd"]
  E --> F["ফেন্স + সৎ UX"]
```

ভাঙে প্রযুক্তির নামে নয়, চুক্তির অভাবে। Vue/Quasar স্ক্রিন আর Laravel রাইট যদি উল্টো উত্তর ধরে, প্রোডাকশন সেই রেসটা খুঁজে বের করে। এই টপিকের চুক্তিটা হলো: Cluster ফিরে আসে, ৪০,০০০ client একই ২০০ms-এ reconnect করে, আর cold cache নিয়ে আবার fail করেন। Recovery-র নিজের capacity plan আর নিজের jitter দরকার।
...
Cluster ফিরে আসে, ৪০,০০০ client একই ২০০ms-এ reconnect করে, আর cold cache নিয়ে আবার fail করেন। Recovery-র নিজের capacity plan আর নিজের jitter দরকার। এই বাক্য পিআর, Pinia অ্যাকশন, আর Laravel ক্লাসে রাখুন।
...
ক্রস-রিজিয়ন ল্যাগ, লক ওয়েট, আর স্প্লিট-ব্রেইন ধরা। **Recovery-তে thundering herd**-এর রিগ্রেশন এই চার্টে না ধরা পড়লে পাঠ শেষ হয়নি।
...
- [ ] **Recovery-তে thundering herd**-এর ইনভেরিয়েন্ট এক বাক্যে লেখা।
- [ ] খালি, ডুপ্লিকেট, টাইমআউট বা পারমিশন পাথের টেস্ট বা রিহার্সাল আছে।
- [ ] এক ডিপ্লয়ের মধ্যে রিগ্রেশন ধরার লগ বা চার্ট আছে।
- [ ] আত্মীয় পাঠ এখনও মিলছে: consistent-hashing-rebalance, leader-election-failure-modes, gossip-and-membership-protocols।
