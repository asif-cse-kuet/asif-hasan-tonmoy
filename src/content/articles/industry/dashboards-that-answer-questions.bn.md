> **পাঠ 71 · মাঝারি ধাপ** - 03:00-এ নব্বইটা CPU panel কিছু বলে না - প্রশ্ন থেকে শুরু করুন, triage flow অনুযায়ী panel সাজান, যেটায় কেউ কখনো action নেয়নি সেটা মুছুন।
...
- এই পাঠটা ঠিক **দেয়াল সাজানো নয়, প্রশ্নের উত্তর দেওয়া dashboard** নিয়ে। ট্যাগ: grafana, dashboards, triage, promql, ux।
...
flowchart TD
  ...
  B --> C["চার লগ সাইলো"]
  C --> D["দীর্ঘ TTD"]
  D --> E["দেয়াল সাজানো নয়, প্রশ্নের উত্তর দেওয়া dashboard"]
  E --> F["কোরিলেট + SLI"]
```

ভাঙে প্রযুক্তির নামে নয়, চুক্তির অভাবে। Vue/Quasar স্ক্রিন আর Laravel রাইট যদি উল্টো উত্তর ধরে, প্রোডাকশন সেই রেসটা খুঁজে বের করে। এই টপিকের চুক্তিটা হলো: 03:00-এ নব্বইটা CPU panel কিছু বলে না - প্রশ্ন থেকে শুরু করুন, triage flow অনুযায়ী panel সাজান, যেটায় কেউ কখনো action নেয়নি সেটা মুছুন।
...
03:00-এ নব্বইটা CPU panel কিছু বলে না - প্রশ্ন থেকে শুরু করুন, triage flow অনুযায়ী panel সাজান, যেটায় কেউ কখনো action নেয়নি সেটা মুছুন। এই বাক্য পিআর, Pinia অ্যাকশন, আর Laravel ক্লাসে রাখুন।
...
SLI বার্ন, রিকোয়েস্ট-আইডি জোড়া, আর মালিক-ম্যাপ করা অ্যালার্ট। **দেয়াল সাজানো নয়, প্রশ্নের উত্তর দেওয়া dashboard**-এর রিগ্রেশন এই চার্টে না ধরা পড়লে পাঠ শেষ হয়নি।
...
- [ ] **দেয়াল সাজানো নয়, প্রশ্নের উত্তর দেওয়া dashboard**-এর ইনভেরিয়েন্ট এক বাক্যে লেখা।
- [ ] খালি, ডুপ্লিকেট, টাইমআউট বা পারমিশন পাথের টেস্ট বা রিহার্সাল আছে।
- [ ] এক ডিপ্লয়ের মধ্যে রিগ্রেশন ধরার লগ বা চার্ট আছে।
- [ ] আত্মীয় পাঠ এখনও মিলছে: red-and-use-methods, golden-signals-instrumentation, alert-design-and-noise-reduction।
