> **পাঠ 164 · উন্নত ধাপ** - 2PC atomicity দেয় আর সাথে এমন coordinator যা সব participant জমিয়ে দিতে পারে; saga availability দেয় আর compensation লেখার দায়িত্ব। বেশিরভাগ দলের দরকার saga + outbox।
...
- এই পাঠটা ঠিক **Two-phase commit vs saga** নিয়ে। ট্যাগ: 2pc, saga, transactions, compensation, outbox।
...
flowchart TD
  ...
  D --> E["Two-phase commit vs saga"]
  E --> F["ফেন্স + সৎ UX"]
```

ভাঙে প্রযুক্তির নামে নয়, চুক্তির অভাবে। Vue/Quasar স্ক্রিন আর Laravel রাইট যদি উল্টো উত্তর ধরে, প্রোডাকশন সেই রেসটা খুঁজে বের করে। এই টপিকের চুক্তিটা হলো: 2PC atomicity দেয় আর সাথে এমন coordinator যা সব participant জমিয়ে দিতে পারে; saga availability দেয় আর compensation লেখার দায়িত্ব। বেশিরভাগ দলের দরকার saga + outbox।
...
2PC atomicity দেয় আর সাথে এমন coordinator যা সব participant জমিয়ে দিতে পারে; saga availability দেয় আর compensation লেখার দায়িত্ব। বেশিরভাগ দলের দরকার saga + outbox। এই বাক্য পিআর, Pinia অ্যাকশন, আর Laravel ক্লাসে রাখুন।
...
ক্রস-রিজিয়ন ল্যাগ, লক ওয়েট, আর স্প্লিট-ব্রেইন ধরা। **Two-phase commit vs saga**-এর রিগ্রেশন এই চার্টে না ধরা পড়লে পাঠ শেষ হয়নি।
...
- [ ] **Two-phase commit vs saga**-এর ইনভেরিয়েন্ট এক বাক্যে লেখা।
- [ ] খালি, ডুপ্লিকেট, টাইমআউট বা পারমিশন পাথের টেস্ট বা রিহার্সাল আছে।
- [ ] এক ডিপ্লয়ের মধ্যে রিগ্রেশন ধরার লগ বা চার্ট আছে।
- [ ] আত্মীয় পাঠ এখনও মিলছে: distributed-locks-correctness, eventual-consistency-user-experience, quorum-read-write-tuning।
