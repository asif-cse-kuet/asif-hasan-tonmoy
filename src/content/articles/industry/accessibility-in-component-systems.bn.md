> **পাঠ 01 · শুরুর ধাপ** - focus trap, ARIA contract, আর a11y regression component-এর মতোই দ্রুত ছড়ায় কেন।
...
- এই পাঠটা ঠিক **shared component system-এ accessibility** নিয়ে। ট্যাগ: accessibility, aria, wcag, components, focus-management।
...
flowchart TD
  ...
  C --> D["মাইনর ভার্সন"]
  D --> E["shared component system-এ accessibility"]
  E --> F["কিবোর্ড বা LCP ইনসিডেন্ট"]
```

ভাঙে প্রযুক্তির নামে নয়, চুক্তির অভাবে। Vue/Quasar স্ক্রিন আর Laravel রাইট যদি উল্টো উত্তর ধরে, প্রোডাকশন সেই রেসটা খুঁজে বের করে। এই টপিকের চুক্তিটা হলো: focus trap, ARIA contract, আর a11y regression component-এর মতোই দ্রুত ছড়ায় কেন।
...
focus trap, ARIA contract, আর a11y regression component-এর মতোই দ্রুত ছড়ায় কেন। এই বাক্য পিআর, Pinia অ্যাকশন, আর Laravel ক্লাসে রাখুন।
...
প্রতি রুটে LCP, ডাউনলোড হওয়া JS, আর ডিপ্লয়প্রতি axe লঙ্ঘন। **shared component system-এ accessibility**-এর রিগ্রেশন এই চার্টে না ধরা পড়লে পাঠ শেষ হয়নি।
...
- [ ] **shared component system-এ accessibility**-এর ইনভেরিয়েন্ট এক বাক্যে লেখা।
- [ ] খালি, ডুপ্লিকেট, টাইমআউট বা পারমিশন পাথের টেস্ট বা রিহার্সাল আছে।
- [ ] এক ডিপ্লয়ের মধ্যে রিগ্রেশন ধরার লগ বা চার্ট আছে।
- [ ] আত্মীয় পাঠ এখনও মিলছে: design-system-versioning, form-validation-architecture।
