> **পাঠ 118 · উন্নত ধাপ** - jitter-সহ backoff, resume cursor, gap বেশি হলে snapshot fallback।
...
- এই পাঠটা ঠিক **Realtime UI reconnection handling** নিয়ে। ট্যাগ: websocket, reconnect, realtime, resync, backoff।
...
ভাঙে প্রযুক্তির নামে নয়, চুক্তির অভাবে। Vue/Quasar স্ক্রিন আর Laravel রাইট যদি উল্টো উত্তর ধরে, প্রোডাকশন সেই রেসটা খুঁজে বের করে। এই টপিকের চুক্তিটা হলো: jitter-সহ backoff, resume cursor, gap বেশি হলে snapshot fallback।
...
jitter-সহ backoff, resume cursor, gap বেশি হলে snapshot fallback। এই বাক্য পিআর, Pinia অ্যাকশন, আর Laravel ক্লাসে রাখুন।
...
প্রতি রুটে LCP, ডাউনলোড হওয়া JS, আর ডিপ্লয়প্রতি axe লঙ্ঘন। **Realtime UI reconnection handling**-এর রিগ্রেশন এই চার্টে না ধরা পড়লে পাঠ শেষ হয়নি।
...
- [ ] **Realtime UI reconnection handling**-এর ইনভেরিয়েন্ট এক বাক্যে লেখা।
- [ ] খালি, ডুপ্লিকেট, টাইমআউট বা পারমিশন পাথের টেস্ট বা রিহার্সাল আছে।
- [ ] এক ডিপ্লয়ের মধ্যে রিগ্রেশন ধরার লগ বা চার্ট আছে।
- [ ] আত্মীয় পাঠ এখনও মিলছে: websocket-state-at-scale, offline-first-sync-conflicts।
