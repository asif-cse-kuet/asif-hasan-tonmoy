...
export const CAPABILITIES: Capability[] = [
  {
    ...
    headline: {
      en: 'Production features from database row to Quasar pixel on Vue, Pinia, Laravel, and PHP.',
      bn: 'ডেটাবেস সারি থেকে Quasar পিক্সেল: Vue, Pinia, Laravel ও PHP-তে প্রোডাকশন ফিচার।',
    },
    clusters: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          'Quasar components & layouts',
          'Pinia stores & Vue Router',
          'Axios, CSRF & API clients',
          'Vite pipelines & SPA forms',
