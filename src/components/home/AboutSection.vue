...
const facts = [
  ...
  },
  {
    ...
    value: {
      en: 'Open for owners who need one hire to handle clients, architect platforms end to end, and ship — Tech Lead, solution architecture, Growth Director, or both chairs.',
      bn: 'যে মালিক এক নিয়োগে ক্লায়েন্ট হ্যান্ডেল, প্ল্যাটফর্ম এন্ড-টু-এন্ড আর্কিটেক্ট ও শিপ চান — টেক লিড, সলিউশন আর্কিটেকচার, গ্রোথ ডিরেক্টর, বা দুই আসন।',
    },
  },
]
